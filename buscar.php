...
if ($result) {
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($column = mysqli_fetch_array($result)) {
            ...
            echo "<tr>";
            echo "<td>" . $column['cita_id'] . "</td>";
            echo "<td>" . $column['fecha_cita'] . "</td>";
            echo "<td>" . $column['nombre_usuario'] . "</td>";
            echo "<td>" . $column['telefono_usuario'] . "</td>";
            echo "<td>" . $column['nombre_mascota'] . "</td>";
            echo "<td>" . $column['edad_mascota'] . " años</td>";
            echo "<td>" . $column['raza_mascota'] . "</td>";
            echo "</tr>";
        }
