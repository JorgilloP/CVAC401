...
<style scoped>
    ...
    .btn-table-update:hover {
        background-color: rgb(200, 60, 30);
...
if ($result) {
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<form method="post" action="eliminar-cita.php">';
        echo "<table>";
        echo "<tr>";
        echo "<th>ID</th>";
        echo "<th>Fecha</th>";
        ...
        while ($column = mysqli_fetch_array($result)) {
            ...
            echo "<td><button class='btn-table-update' type='submit' name='delete' value='" . $column['id'] . "'>Eliminar</button></td>";
            echo "</tr>";
        }
